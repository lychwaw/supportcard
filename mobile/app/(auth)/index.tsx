      ...
      >
        ...
        <View style={{ gap: 12, marginBottom: 24 }}>
          ...
          >
            ...
            <Text style={{ fontSize: 15, fontWeight: '600', color: colors.label }}>Continue with Google</Text>
          </Pressable>

          {/* iOS and web only. expo-apple-authentication has no Android
              implementation, so on Android this button rendered fine and then
              threw the moment it was tapped — on the first screen every new
              user sees. Apple requires this option on iOS when other social
              logins are offered; Google has no equivalent requirement. */}
          {Platform.OS !== 'android' && (
            <Pressable
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 24 }}>
          ...
          <Text style={{ fontSize: 12, color: colors.secondaryLabel, fontWeight: '500' }}>or sign in with email</Text>
          <View style={{ flex: 1, height: 1, backgroundColor: brand.separator }} />
        </View>

        {/* Email field */}
        <View style={{ marginBottom: 20 }}>
          <Text style={{ fontSize: 13, fontWeight: '600', color: colors.label, marginBottom: 8, letterSpacing: 0.1 }}>
            Email address
          </Text>
          <TextInput
            value={email}
            ...
            style={{
              ...
              fontSize: 15, color: colors.label, borderCurve: 'continuous',
            }}
          />
        </View>
          ...
          <View style={{ position: 'relative' }}>
            <TextInput
              ...
              style={{
                ...
                backgroundColor: colors.surface, paddingHorizontal: 16, paddingRight: 52,
                fontSize: 15, color: colors.label, borderCurve: 'continuous',
              }}
            />
            <Pressable
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 32 }}>
          <Text style={{ fontSize: 14, color: colors.secondaryLabel }}>{"Don't have an account? "}</Text>
